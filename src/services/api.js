...
export const authService = {
  ...
  login: async (credentials) => {
    // Create a custom axios instance for login to prevent console errors
    const loginAxios = axios.create();
    
    // Override the console error behavior for this instance
    const originalConsoleError = console.error;
    console.error = () => {};
    
    try {
      const response = await loginAxios.post(`${AUTH_API_URL}/login`, credentials);
